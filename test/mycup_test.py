...
import serial, sys, time, math, random
...
def all_on_level(level):
   for i in lights:
     mydmx.setChannel(i, level, autorender=True)
...
while True:
   ...
   # 3 button -> all on / all off / candle
   # spinnning -> light turning around / rotate()
   # shaking -> random flicker